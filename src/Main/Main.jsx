...
export default function Main() {
    ...
    const handleAddToCart = async (item) => {
        ...
        try {
            ...
            await axios.post(
                'http://UzumMarket12.pythonanywhere.com/api/add_cart/',
                { id: item.id },
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            setLoading(true);
            try {
                const productResponse = await axios.get('http://UzumMarket12.pythonanywhere.com/api/products/');
    ...
    useEffect(() => {
        const fetchCartItems = async () => {
            try {
                ...
                const cartResponse = await axios.get('http://UzumMarket12.pythonanywhere.com/api/get_cart_items/', {
                    headers: {
                        'Authorization': `Bearer ${accessToken}`
                    }
                });
