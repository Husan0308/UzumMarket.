...
const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || "https://UzumMarket12.pythonanywhere.com";
...
export default function Navbar({ search, value, cartCount }) {
    ...
    useEffect(() => {
        ...
        setIsLoggedIn(!!accessToken); // Set authentication state based on token presence
    }, []);
